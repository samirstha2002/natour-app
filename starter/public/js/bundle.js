      ...
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          ...
          if (res.data.status === 'sucess') {
            (0, _alert.showAlert)('success', 'Signedup Sucessfully');
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 1:
          res = _context.v;
          if (res.data.status === 'sucess') {
            (0, _alert.showAlert)('success', 'Logged in sucessfully');
            window.setTimeout(function () {
              location.assign('/');
            }, 1500);
          }
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc) {
    new maplibregl.Marker().setLngLat(loc.coordinates).setPopup(new maplibregl.Popup({
      offset: 25
    }).setText("Day ".concat(loc.day, ": ").concat(loc.description))).addTo(map);
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          stripe = Stripe('pk_test_51SVpHG9DzqTWbDKcXssPn7oRfxdCdpfw4HuTQhGabXKWcDia9a2kBlKpqjXzDTx0d0KAplfejpBqN68h8ZkEatFS00I6ZcPuto');
          _context.p = 1;
          _context.n = 2;
...
var userDataSettingsForm = document.querySelector('.form-user-data');
var userPasswordSettingsForm = document.querySelector('.form-user-settings');
