  ...
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          stripe = Stripe('pk_test_51SVpHG9DzqTWbDKcXssPn7oRfxdCdpfw4HuTQhGabXKWcDia9a2kBlKpqjXzDTx0d0KAplfejpBqN68h8ZkEatFS00I6ZcPuto'); //1 GET CHECKOUT SESSION FROM API
          _context.n = 1;
